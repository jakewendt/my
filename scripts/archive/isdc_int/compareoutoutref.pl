...
#	040301 - Jake
#
#	This script was used to compare the data 
...
#		diff -r before after
#
#			diff -r before/002500000041.000.osm after/002500000041.000.osm
#			27c27
#			< Log_1  : SPI.-480C-HRW        TABLE Cols=       327, Rows=         1
#			---
#			> Log_1  : SPI.-480C-HRW        TABLE Cols=       329, Rows=         1
#			diff -r before/002500000041.000.raw after/002500000041.000.raw
#			27c27
#			< Log_1  : SPI.-480C-HRW        TABLE Cols=       327, Rows=         1
#			---
#			> Log_1  : SPI.-480C-HRW        TABLE Cols=       329, Rows=         1
#			diff -r before/002500000051.000.osm after/002500000051.000.osm
#			50c50
#			< Log_1  : SPI.-480C-HRW        TABLE Cols=       327, Rows=         5
#			---
#			> Log_1  : SPI.-480C-HRW        TABLE Cols=       329, Rows=         5
#			80c80
#			< Log_1  : SPI.-ORHK-HRW        TABLE Cols=         4, Rows=         4
#			---
#			> Log_1  : SPI.-ORHK-HRW        TABLE Cols=        21, Rows=         4
#			diff -r before/002500000051.000.raw after/002500000051.000.raw
#			50c50
#			< Log_1  : SPI.-480C-HRW        TABLE Cols=       327, Rows=         5
#			---
#			> Log_1  : SPI.-480C-HRW        TABLE Cols=       329, Rows=         5
