...
int main(int argc, char *argv[])
{
	...
	double *pix, sum = 0., maxval = -1.E33;
//	axeval = 0., minval = 1.E33, maxval = -1.E33;

	if (argc != 2) { 
		printf("Usage: imagemax image \n");
		printf("\n");
		printf("Compute maximum of pixels in the input image\n");
		printf("\n");
		printf("Examples: \n");
		printf("  imagemax image.fits                    - the whole image\n");
//		printf("  imagemax 'image.fits[200:210,300:310]' - image section\n");
//		printf("  imagemax 'table.fits+1[bin (X,Y) = 4]' - image constructed\n");
