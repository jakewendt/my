...
int main(int argc, char *argv[])
{
	...
	double *pix, sum = 0., aveval = 0.;	//, minval = 1.E33, maxval = -1.E33;

	if (argc != 2) { 
		printf("Usage: imageave image \n");
		printf("\n");
		printf("Compute average of pixels in the input image\n");
		printf("\n");
		printf("Examples: \n");
		printf("  imageave image.fits                    - the whole image\n");
//		printf("  imageave 'image.fits[200:210,300:310]' - image section\n");
//		printf("  imageave 'table.fits+1[bin (X,Y) = 4]' - image constructed\n");
