...
int main(int argc, char *argv[])
{
	...
	double *pix, sum = 0., minval = 1.E33;
//	axeval = 0., minval = 1.E33, maxval = -1.E33;

	if (argc != 2) { 
		printf("Usage: imagemin image \n");
		printf("\n");
		printf("Compute minimum of pixels in the input image\n");
		printf("\n");
		printf("Examples: \n");
		printf("  imagemin image.fits                    - the whole image\n");
//		printf("  imagemin 'image.fits[200:210,300:310]' - image section\n");
//		printf("  imagemin 'table.fits+1[bin (X,Y) = 4]' - image constructed\n");
